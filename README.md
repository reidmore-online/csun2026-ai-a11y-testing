...
In this repository we have provided some of the resources and links we shared during our talk. You can find some sample context files and prompt templates here as well, just to provide guidance. 

## References from the talk

- [Evo Web](https://opensource.ebay.com/evo-web/)
- [Accessibility LLM Evaluation Report](https://microsoft.github.io/a11y-llm-eval-report/)
- [AI Model Accessibility Checker](https://aimac.ai/)
